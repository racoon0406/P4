...
register<bit<32> >(1025 * 5) db_value; //version# is limited [0,5]
register<bit<32> >(1025) lastest_version; //version 0 means key not exists
...
control MyIngress(inout headers hdr,
    ...
    action put() {
        ...
        db_value.write(hdr.query.key1 * 5 + meta.version, hdr.query.value);
        lastest_version.write(hdr.query.key1, meta.version + 1);
        }
    }
